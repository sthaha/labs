...
import StopWatch from "./apps/TestTimer.svelte";
...
import HexaPattern from "./beyond/HexaPattern.svelte";
...
let entries = [
  ...
  {link: "beyond/hexa", summary: "Hexa Pattern", description: " ... "},
...
<Router url="{url}">
  ...
  <div class="bg-gray-200 mt-14 w-screen h-screen flex flex-col">
    ...
    <div class="flex mt-6 flex-col mx-4">
      ...
      <Route path="beyond/hexa" component="{HexaPattern}" />
